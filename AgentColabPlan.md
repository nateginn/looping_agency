...
_Round 2 (final) — revised by Claude after two Codex adversarial review rounds (21 findings → 5 residual, all incorporated; see PLAN-REVIEW-LOG.md). Codex's last formal verdict was REVISE; the 5 residual fixes below were folded in after the round cap — human sign-off is the tie-break._
